...
public class TestConverterInterceptorRecursive implements ConverterInterceptorRecursive {
	
	public int afterConvertRecursive = 0;
	public int beforeConvertRecursive = 0;
